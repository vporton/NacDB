...
import { idlFactory } from './stresser.did.js';
export { idlFactory } from './stresser.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_STRESSER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./stresser.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the stresser canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./stresser.did.js")._SERVICE>}
 */
export const stresser = createActor(canisterId);
